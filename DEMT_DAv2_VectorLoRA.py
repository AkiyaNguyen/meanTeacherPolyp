    ...
    def _freeze_dav2_backbone(self) -> None:
        ...
        if hasattr(self.tea_model, 'dav2_encoder'):
            for name, param in self.tea_model.dav2_encoder.named_parameters():
                # Bỏ qua các tham số của LoRA để không bị đóng băng nhầm
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='cfg/DEMT_DAv2_VectorLoRA.yaml', help='Path to YAML config')
